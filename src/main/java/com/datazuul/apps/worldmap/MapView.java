...
public class MapView extends FrameView {
	...
	private void initComponents() {
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application
				.getInstance(MapApp.class).getContext().getActionMap(
						MapView.class, this);
		...
		mainPanelLayout.setHorizontalGroup(mainPanelLayout.createParallelGroup(
				...
				mainPanelLayout.createSequentialGroup().add(jButton1)
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED).add(
								jButton2).add(183, 183, 183)).add(jXMapKit1,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 424,
				Short.MAX_VALUE));
		mainPanelLayout.setVerticalGroup(mainPanelLayout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				org.jdesktop.layout.GroupLayout.TRAILING,
				mainPanelLayout.createSequentialGroup().add(jXMapKit1,
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(MapApp.class).getContext().getResourceMap(
						MapView.class);
